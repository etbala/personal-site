...
export const RESUME = {
  ...
  experience: [
    ...
    },
    {
      ...
      org: 'JPMorganChase',
      blurb: 'Automated manual processes for CIB Credit Agreement Monitoring Platform.',
  ...
  opensource: [
    {
      ...
      stack: [],
      links: [{ label: 'ranaroussi/yfinance', href: 'https://github.com/ranaroussi/yfinance/issues?q=is%3Apr%20author%3A%40etbala' }],
    },
    {
      period: 'Apr 2026 — Present',
      role: 'Contributor',
      ...
      stack: [],
      links: [{ label: 'tursodatabase/turso', href: 'https://github.com/tursodatabase/turso/issues?q=is%3Apr%20author%3A%40etbala' }],
    },
    {
      period: 'Mar 2026 — Present',
      role: 'Contributor',
      org: 'microsoft/terminal',
      blurb: 'The Windows 11 Terminal.',
      stack: [],
      links: [{ label: 'microsoft/terminal', href: 'https://github.com/microsoft/terminal/issues?q=is%3Apr%20author%3A%40etbala' }],
    },
  ] as ResumeItem[],
